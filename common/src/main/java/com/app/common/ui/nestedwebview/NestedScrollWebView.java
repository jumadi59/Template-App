package com.app.common.ui.nestedwebview;
...
public class NestedScrollWebView extends WebView implements NestedScrollingChild3 {
    ...
    private void initScrollView() {
        ...
        radius = getResources().getDimensionPixelSize(R.dimen.radius_xxxl);
    }
    ...
    public void draw(Canvas canvas) {
        if (radius > 0) {
            ...
            clipPath.addRoundRect(new RectF(computeHorizontalScrollOffset(), computeVerticalScrollOffset(), computeHorizontalScrollExtent(), computeVerticalScrollRange()), corners, Path.Direction.CW);
